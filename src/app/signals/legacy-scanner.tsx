...
export default function LegacySignalScanner({ onAdvanced }: { onAdvanced: () => void }) {
  ...
  return (
    <DashboardLayout>
      <Button variant="outline" className="mb-4" onClick={onAdvanced}>Kembali ke Signals Advanced</Button>
