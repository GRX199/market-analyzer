...
CRYPTO = {"BTC", "ETH", "SOL", "BNB", "XRP", "ADA", "DOGE", "DOT", "LINK", "MATIC", "POL", "AVAX", "SHIB", "LTC", "UNI", "ATOM", "ETC", "BCH", "TRX", "SUI", "NEAR", "AAVE", "XLM", "FIL", "ARB", "OP", "INJ", "ICP", "APT", "HBAR", "VET", "ALGO"}
CURRENCIES = {"USD", "EUR", "JPY", "GBP", "CHF", "CAD", "AUD", "NZD", "SGD", "HKD", "ZAR", "MXN", "TRY", "IDR", "CNH", "NOK", "SEK", "PLN"}
